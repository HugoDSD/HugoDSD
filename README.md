...
- **[SobrIA] (https://github.com/HugoDSD/Innovation_Project/tree/Hassane)** - A project whose goal was to allow users to determine the best use of AI for them by providing the cost in money and natural resources.
- **[Image-Classifier-with-CNNs] (https://github.com/HugoDSD/Building-an-Image-Classifier-with-CNNs)** - In this project, I have explored how Convolutional Neural Networks (CNNs) can be used to classify images : here if an image is a cat or a dog.
---
